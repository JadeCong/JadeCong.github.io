...
image: 
  path: /assets/images/blogs/blog.jpg
description: >
...
Good images are key to making the most out of content cards. For that reason, a [chapter on images](https://hydejack.com/docs/basics/#adding-images) has been added to the documentation.
...
Read the the [CHANGELOG](https://hydejack.com/CHANGELOG/){:.heading.flip-title} for the full scope of features and improvements made in Hydejack 9.
